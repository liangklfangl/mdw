...
/**
 * [Filename is absolute path for meta data, content is markdown data,plugins is used to process md file]
...
exports.process = function (filename, fileContent, plugins, isBuild /* 'undefined' | true */) {
  ...
  //meta.filename is for absolute filepath
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(ensureToBeArray, 'ensureToBeArray', 'src/utils/processMd.js');

  __REACT_HOT_LOADER__.register(isDirectory, 'isDirectory', 'src/utils/processMd.js');

  __REACT_HOT_LOADER__.register(isMDFile, 'isMDFile', 'src/utils/processMd.js');

  __REACT_HOT_LOADER__.register(findMDFile, 'findMDFile', 'src/utils/processMd.js');

  __REACT_HOT_LOADER__.register(rxSep, 'rxSep', 'src/utils/processMd.js');

  __REACT_HOT_LOADER__.register(filesToTreeStructure, 'filesToTreeStructure', 'src/utils/processMd.js');

  __REACT_HOT_LOADER__.register(stringifyObject, 'stringifyObject', 'src/utils/processMd.js');

  __REACT_HOT_LOADER__.register(lazyLoadWrapper, 'lazyLoadWrapper', 'src/utils/processMd.js');

  __REACT_HOT_LOADER__.register(shouldLazyLoad, 'shouldLazyLoad', 'src/utils/processMd.js');

  __REACT_HOT_LOADER__.register(stringify, 'stringify', 'src/utils/processMd.js');
}();
