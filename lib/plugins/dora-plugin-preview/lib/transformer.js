...
module.exports = function transformer(content, lang) {
  var fs = require('fs');
  fs.writeFile('ast.js', content, function () {
    console.log('ended');
  });
  var imports = [];
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(traverse, 'traverse', 'src/plugins/dora-plugin-preview/lib/transformer.js');

  __REACT_HOT_LOADER__.register(parser, 'parser', 'src/plugins/dora-plugin-preview/lib/transformer.js');
}();
