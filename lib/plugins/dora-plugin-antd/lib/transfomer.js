...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(traverse, 'traverse', 'src/plugins/dora-plugin-antd/lib/transfomer.js');

  __REACT_HOT_LOADER__.register(generator, 'generator', 'src/plugins/dora-plugin-antd/lib/transfomer.js');

  __REACT_HOT_LOADER__.register(errorBoxStyle, 'errorBoxStyle', 'src/plugins/dora-plugin-antd/lib/transfomer.js');

  __REACT_HOT_LOADER__.register(requireGenerator, 'requireGenerator', 'src/plugins/dora-plugin-antd/lib/transfomer.js');

  __REACT_HOT_LOADER__.register(defaultBabelConfig, 'defaultBabelConfig', 'src/plugins/dora-plugin-antd/lib/transfomer.js');
}();
