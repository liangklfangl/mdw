...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(babelrc, 'babelrc', 'src/plugins/dora-plugin-antd/lib/process-demo2.js');

  __REACT_HOT_LOADER__.register(tmpl, 'tmpl', 'src/plugins/dora-plugin-antd/lib/process-demo2.js');

  __REACT_HOT_LOADER__.register(isStyleTag, 'isStyleTag', 'src/plugins/dora-plugin-antd/lib/process-demo2.js');

  __REACT_HOT_LOADER__.register(getCode, 'getCode', 'src/plugins/dora-plugin-antd/lib/process-demo2.js');

  __REACT_HOT_LOADER__.register(getChineseIntroStart, 'getChineseIntroStart', 'src/plugins/dora-plugin-antd/lib/process-demo2.js');

  __REACT_HOT_LOADER__.register(getEnglishIntroStart, 'getEnglishIntroStart', 'src/plugins/dora-plugin-antd/lib/process-demo2.js');

  __REACT_HOT_LOADER__.register(getCodeIndex, 'getCodeIndex', 'src/plugins/dora-plugin-antd/lib/process-demo2.js');

  __REACT_HOT_LOADER__.register(getCorrespondingTSX, 'getCorrespondingTSX', 'src/plugins/dora-plugin-antd/lib/process-demo2.js');

  __REACT_HOT_LOADER__.register(getSourceCodeObject, 'getSourceCodeObject', 'src/plugins/dora-plugin-antd/lib/process-demo2.js');

  __REACT_HOT_LOADER__.register(getStyleNode, 'getStyleNode', 'src/plugins/dora-plugin-antd/lib/process-demo2.js');
}();
