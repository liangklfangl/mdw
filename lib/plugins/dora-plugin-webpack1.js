...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(webpackConfig, 'webpackConfig', 'src/plugins/dora-plugin-webpack1.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/plugins/dora-plugin-webpack1.js');
}();
