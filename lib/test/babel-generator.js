...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(code, 'code', 'src/test/babel-generator.js');

  __REACT_HOT_LOADER__.register(ast, 'ast', 'src/test/babel-generator.js');

  __REACT_HOT_LOADER__.register(output, 'output', 'src/test/babel-generator.js');
}();
