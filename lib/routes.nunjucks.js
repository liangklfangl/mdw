...
var NotFound = require('{{ themePath }}/template/NotFound.jsx');
  ...
  */
  function processRoutes(route) {
    ...
    return _extends({}, route, {
      ...
      indexRoute: route.indexRoute && _extends({}, route.indexRoute, {
        component: undefined,
